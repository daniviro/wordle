    ...
    checkWord(wordIn: String): String{
        ...
        wordInArray.forEach((element, index) => {
            ...
            if (wordArray.indexOf(element) > -1 && matches[index] != "O") {
                matches[index] = "W";
                wordArray[this.word.indexOf(element)] = "_";
            }
        });
        return matches.join("");
    }
